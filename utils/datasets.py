...
class Build_Dataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        del img_org, bboxes_org, img_mix, bboxes_mix  # 删除变量
    ...
    def __parse_annotation(self, annotation):
        ...
        # 数据增强操作 水平翻转、随机裁剪、仿射变换和缩放
        img, bboxes = dataAug.RandomGammaCorrection()(
        ...
        img, bboxes = dataAug.RandomHSV()(np.copy(img), np.copy(bboxes))
        img, bboxes = dataAug.RandomBlur()(np.copy(img), np.copy(bboxes))
    ...
    def __creat_label(self, bboxes):
        ...
        for bbox in bboxes:
            ...
            # 将bbox中[xmin,ymin,xmax,ymax]转换为[xcenter,ycenter,wwidth,height]
