...
class Trainer(object):
    def __init__(self, weight_path=None,
        ...
        self.multi_scale_train = cfg.TRAIN["MULTI_SCALE_TRAIN"]  # default=true
        self.showatt = cfg.TRAIN["showatt"]  # default = false
        if self.multi_scale_train:
            print("Using multi scales training")
        else:
            torch.nn.Unfold()  # 提取滑动窗口数据
